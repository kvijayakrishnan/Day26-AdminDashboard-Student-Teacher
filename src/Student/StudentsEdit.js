...
export default function Studentssedit(props) {
  ...
  useEffect(async () => {
    let data = await fetch(
      `https://63f50ba255677ef68bc8f99d.mockapi.io/Student/${props.match.params.id}`
    );
    let parsedData = await data.json();
    formik.values.Name = parsedData.Name;
    formik.values.Emailid = parsedData.Emailid;
    formik.values.Batch = parsedData.Batch;
